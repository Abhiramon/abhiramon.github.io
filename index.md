...
<ul class="experience-list">
  <li class="experience-item">
    <div class="experience-row">
      <div class="experience-header">
        <span class="experience-role">Research Intern</span><span class="experience-org">, <strong>Skyfall AI</strong> &mdash; New York City, NY (Remote)</span>
      </div>
  ...
  <li class="experience-item">
    <div class="experience-row">
      <div class="experience-header">
        <span class="experience-role">Data Science Intern</span><span class="experience-org">, <strong>AT&amp;T</strong> &mdash; Plano, TX (Remote)</span>
      </div>
  ...
  <li class="experience-item">
    <div class="experience-row">
      <div class="experience-header">
        <span class="experience-role">Research Intern</span><span class="experience-org">, <strong>Accenture Labs</strong> &mdash; Bangalore, India</span>
      </div>
  ...
  <li class="experience-item">
    <div class="experience-row">
      <div class="experience-header">
        <span class="experience-role">Summer Analyst</span><span class="experience-org">, <strong>Goldman Sachs</strong> &mdash; Bangalore, India</span>
      </div>
...
<div class="paper-card">
  ...
  <img class="paper-img" src="images/chatbot_flowchart.png?raw=true" alt="Conversational Agents figure"/>
</div>
  ...
  <li class="education-item">
    <div class="education-row">
      <div class="education-header">
        <span class="education-degree">Doctor of Philosophy &ndash; PhD, Computer Science</span>
        <span class="education-org">The University of Texas at Dallas</span>
      </div>
      <span class="education-dates">Aug 2020 &ndash; Aug 2026</span>
    </div>
  </li>
  <li class="education-item">
    <div class="education-row">
      <div class="education-header">
        <span class="education-degree">Integrated Masters (BTech + MTech), Computer Science</span>
        <span class="education-org">International Institute of Information Technology Bangalore</span>
      </div>
      <span class="education-dates">2015 &ndash; 2020</span>
    </div>
    <p class="education-desc"><a href="https://github.com/Abhiramon/Poetry-from-Image-Descriptions/blob/main/Thesis.pdf" target="_blank">Master's Thesis</a>: Addressed the unique challenge of creating rhyming poetry from image captions; developed GPT-2 based model with a novel loss function, increasing rhyme density by 17%.</p>
  </li>
</ul>